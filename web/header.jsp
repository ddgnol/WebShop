...
<html lang="en">
    ...
    <body>
        <div style="position:fixed; top:0px; left:0px; right:0px; z-index: 100 ">
            ...
            <div class="container-fluid  bg-light" style="padding-bottom: 20px;padding-top: 20px;display:flex">
                <a class=" justify-content-center" href="index.jsp" style="padding-bottom: 30px ">
                        ...
                        <li><a href="#" class=" justify-content-end float-right " data-toggle="dropdown" style="color: black;font-weight:700;font-size: 80%"><i class="fas fa-user" style="  color: brown;"></i>Chào ${cus.name} , Mã KH : ${cus.id}</a>
                            <ol>
                                ...
                                <li><a href="CustomerCart">Quản lý đơn hàng</a></li>
                                    ...
                                    %>
                                <li><a href="AdminView">Quản lý kho</a></li>
                                    <%                                   
                                        }
                                    %>
            ...
            <div id="formlogin">
                ...
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center ">
                    <ul class="navbar-nav  ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="logchange" href="LoginForward" onclick="changelog()">ĐĂNG NHẬP</a>
                        </li>
                    </ul>
                </nav>
                <br>
